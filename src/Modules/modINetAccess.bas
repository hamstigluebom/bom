...
End Sub
Public Function ShortPost(ByVal strUrl As String, Optional ByVal sPostData As String = "", Optional ByVal sReferer As String = "", Optional ByVal sEBayUser As String = "", Optional bWait As Boolean = True) As String
Dim bOk As Boolean
